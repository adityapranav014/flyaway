...
<body
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			...
			<div class="collapse navbar-collapse mx-5" id="navbarTogglerDemo02">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item "><a href="home-admin.jsp"
						class="nav-link">Home</a></li>
					<li class="nav-item active"><a
						href="save-flightdetails-admin.jsp" class="nav-link">Add
							Flight Details</a></li>
	...
	<!-- Form -->
	<div class="container col-md-5 mt-4 pb-5">
		<div class="card shadow-lg">
			<div class="card-body">
				<form action="SaveFlightDetails" method="post">
					<h2 class="card-title">Add Flight</h2>

					<fieldset class="form-group">
						<label>Flight No</label> <input type="number"
							placeholder="Enter Flight No" value="" class="form-control"
							name="fno" required>
					</fieldset>

					<fieldset class="form-group">
						<label>Airline</label> <input type="text"
							placeholder="Enter Airline Name" value="" class="form-control"
					...
					<fieldset class="form-group">
						<label>Fare</label> <input type="number" placeholder="Enter Fare"
							value="" class="form-control" name="fare" required>
					</fieldset>
