			...
			<div class="card-body">
				<form action="SearchFlightCustomer" method="post">
					...
					<div class="form-row">
						<div class="col">
							<div class="form-group">
								<label for="exampleFormControlSelect1">From</label> <select
						...
						<div class="col">
							<div class="form-group">
								<label for="exampleFormControlSelect1">To</label> <select
					...
					<fieldset class="form-group">
						<label>Travel Date</label> <input type="date" value=""
							class="form-control" name="date" required>
					</fieldset>

					<fieldset class="form-group">
						<label>No Of Travelers</label> <input type="text"
							placeholder="Enter No Of Travelers" value="" class="form-control"
							name="noOfTravelers" required>
					</fieldset>
